  ...
  return (
    <section className="cards">
      ...
      >
        <div className="card-front">
          <div className="image-container">
            ...
            <img
              src={innerGroupImage1}
              alt="Inner Group 1"
              className="inner-group-image"
            />
          </div>
        ...
        <div className="card-back">
          <p className="card-description">
            To impart quality technical education with ethical values,
            employable skills and research to achieve excellence.
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div className="card-back">
          <p className="card-description">
            ...
            faculty.To create relevant infrastructure
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div className="card-back">
          <p className="card-description">
            To keep all the infrastructure updated and relevant at any given
            point of time.To provide practical exposes through industry connect.
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div className="card-back">
          <p className="card-description">
            Quality Education Honesty and Integrity Research Work and self
            Improvement Leadership and Entrepreneurship
          </p>
        </div>
      </div>
    </section>
