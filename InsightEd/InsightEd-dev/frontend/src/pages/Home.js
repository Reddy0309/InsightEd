    ...
    <div>
        ...
        <div className="left-section">
          <div className="content-section">
            <p className="About-content">
              This website showcases InsightEd, an educational platform
              committed to empowering learners through community-driven insights
              and resources. Featuring a dynamic array of content, including
              community feedback, informative cards, and engaging visuals,
              InsightEd aims to foster informed decision-making and personal
              growth. From connecting on social media to exploring educational
              opportunities, InsightEd offers a comprehensive digital experience
              tailored for students, educators, and anyone seeking to navigate
              their educational journey with confidence and clarity.
            </p>
          </div>
          ...
          <div className="icon-buttons">
            <button className="icon-button">
              <a
                href="https://www.instagram.com/ksit.official/"
                target="_blank"
            ...
            <button className="icon-button">
              <a
                href="https://www.linkedin.com/school/k-s-institute-of-technology-bangalore/"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <button className="icon-button">
              <a
                href="https://www.facebook.com/ksit.official/"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <button className="icon-button">
              <a
                href="https://x.com/KSIT_official"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div className="bottom-block">
        <div className="bottom-left">
          ...
          <p
            style={{ fontSize: "3rem", color: "#FFFFFF", marginLeft: "250px" }}
          >
            InsightEd- Enhancing Educational Communication
          </p>
      ...
      <div className="Content-section">
        ...
        <p className="community-voices">Technical Talk</p>
        <Feedback />
        <Cards />
        <Footer />
      </div>
