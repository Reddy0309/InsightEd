...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:5000/api/users/login', { usn, password });
        ...
        <div>
            ...
            <div className="signup-page">
                ...
                <br/>
                    ...
                    <label className='label' htmlFor="usn">Enter USN</label>
                        <input
                            type="text"
                            value={usn}
                        ...
                        <br></br>
                        <br></br>
                        <button type="submit" className="signup-button">{t('login')}</button>
                    </form>
                    <br />
                    {message && <p>{message}</p>}
                </div>
